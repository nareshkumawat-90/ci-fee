            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="http://localhost/fee/Students/displaydata"><i class="fa fa-home"></i> Student <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a href="http://localhost/fee/Students/index"><i class="fa fa-edit"></i> Fee <span class="fa fa-chevron-down"></span></a>
                    <!-- <ul class="nav child_menu">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                      ...
                      <?php echo form_open("Students/update_record/{$data->id}",['class'=> 'form-horizontal']); ?>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">First Name *
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="fname" class="form-control col-md-7 col-xs-12" name="fname" value="<?php echo $data->fname; ?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="middle-name" class="form-control col-md-7 col-xs-12" value="<?php echo $data->dob; ?>" type="date" name="dob">
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="" name="contactno" class="form-control col-md-7 col-xs-12" value="<?php echo $data->contactno; ?>" type="text">
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="" name="class" class="date-picker form-control col-md-7 col-xs-12" value="<?php echo $data->class; ?>" type="text">
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="" name="subject" class="form-control col-md-7 col-xs-12" value="<?php echo $data->subject; ?>" type="text">
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="" name="total_fee" class="form-control col-md-7 col-xs-12" value="<?php echo $data->total_fee; ?>" type="text">
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="" name="address" class="form-control col-md-7 col-xs-12" value="<?php echo $data->address; ?>" type="text">
                          </div>
                        </div>
